...
[_QWERTY] = LAYOUT_60_iso( /* Windows ISO layout */
    ...
    RAISE,      KC_A,       KC_S,      KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,        KC_SCLN,    KC_QUOT,    KC_NUHS,    KC_ENT, \
...
[_OSX] = LAYOUT_60_iso( /* OSX ISO layout */
    ...
    KC_TAB,    KC_Q,       KC_W,      KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,        KC_P,       KC_LBRC,    KC_RBRC,            \
    RAISE,     KC_A,       KC_S,      KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,        KC_SCLN,    KC_QUOT,    A(KC_3),    KC_ENT, \
...
[_RAISE] = LAYOUT_60_iso( /* Configuration */
    ...
    KC_TRNS,     QWERTY,    KC_TRNS,   M_ECL  ,    KC_TRNS,    M_TAB,      KC_TRNS,    KC_TRNS,    KC_TRNS,    OSX,         KC_TRNS,    KC_TRNS,    KC_TRNS,            \
    KC_TRNS,     RGB_TOG,   RGB_HUI,   RGB_SAI,    RGB_VAI,    BL_INC,     BL_STEP,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,    KC_TRNS,    KC_TRNS,    M_SRSN,\
    RGB_MOD,     RGB_HUD,   RGB_SAD,   RGB_VAD,    BL_DEC,     BL_TOGG,    KC_TRNS,    KC_TRNS,    M_MANTIS,   KC_TRNS,     KC_TRNS,    KC_TRNS,                KC_TRNS,\
    KC_RCTL,     KC_TRNS,   KC_TRNS,                               KC_PSCR,                                                 KC_TRNS,    KC_RALT,    KC_RGUI,    KC_RCTL),
